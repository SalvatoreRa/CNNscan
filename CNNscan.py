...
from methods import ( fetch_filters, advance_filt, fetch_feature_maps, CamExtractor, 
    ...
    LayerCAM_process, Grad_times_process 
    
     )
from methods import (generate_smooth_grad, smooth_grad_process,
...
from outputs import cam_outputs, outputs_backprop, outputs_scorecam, \
    ...
    outputs_DD, output_inverted, outputs_CGI, outputs_LIME
...
def main():
    ...
    with methods_tab:
        st.write("Here you can explore the different methods")
